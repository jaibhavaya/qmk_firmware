...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------|
   * |Esc/Ctrl| A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|Return |
   * |-----------------------------------------------------------|
   * |LShift  |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /| RShift   |
   * |-----------------------------------------------------------|
   * |Alt|Gui |Ctrl |      Space              |Fn0 |Gui |App|Ctrl|
   * `-----------------------------------------------------------'
   */
  [0] = LAYOUT_60_ansi(
	       ...
	       KC_LALT, KC_LCTL, KC_LGUI,          KC_SPC,                                      MO(1),   KC_RGUI, KC_APP,  KC_RCTL),
   ...
   * |-----------------------------------------------------------|
   * |      |Lft|Dwn|Rig|   |   |Lef|Dwn|Up |Rig|Lef|Rig|        |
   * |-----------------------------------------------------------|
  ...
  [1] = LAYOUT_60_ansi(
	       ...
	       KC_TRNS,   KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_TRNS,  KC_TRNS,  KC_LEFT,   KC_DOWN, KC_UP, KC_RIGHT, KC_LEFT, KC_RIGHT,          KC_TRNS,          \
